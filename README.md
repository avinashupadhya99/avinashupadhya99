...
- [dagger/dagger](https://github.com/dagger/dagger) ([v0.3.0-alpha.1](https://github.com/dagger/dagger/releases/tag/v0.3.0-alpha.1), today) - A portable devkit for CI/CD pipelines
- [getporter/porter](https://github.com/getporter/porter) ([v1.0.1](https://github.com/getporter/porter/releases/tag/v1.0.1), today) - Porter enables you to package your application artifact, client tools, configuration and deployment logic together as an installer that you can distribute, and install with a single command.

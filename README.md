...
- [kubernetes/website](https://github.com/kubernetes/website) ([snapshot-initial-v1.25](https://github.com/kubernetes/website/releases/tag/snapshot-initial-v1.25), 5 days ago) - Kubernetes website and documentation repo: 
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.4.0](https://github.com/elastic/kibana/releases/tag/v8.4.0), 5 days ago) - Your window into the Elastic Stack
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.168](https://github.com/kubescape/kubescape/releases/tag/v2.0.168), 5 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 

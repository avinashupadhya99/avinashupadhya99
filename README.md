...
- [DataDog/integrations-core](https://github.com/DataDog/integrations-core) - Core integrations of the Datadog Agent (2 weeks ago)
...
- [kubernetes/minikube](https://github.com/kubernetes/minikube) ([v1.26.0-beta.0](https://github.com/kubernetes/minikube/releases/tag/v1.26.0-beta.0), 2 days ago) - Run Kubernetes locally
- [civo/cli](https://github.com/civo/cli) ([v1.0.28](https://github.com/civo/cli/releases/tag/v1.0.28), 2 days ago) - Our Command Line Interface (CLI) for interacting with your Civo resources
- [armosec/kubescape](https://github.com/armosec/kubescape) ([v2.0.154](https://github.com/armosec/kubescape/releases/tag/v2.0.154), 3 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
...
- [Fix formatting and typos in annotations docs](https://github.com/Azure/application-gateway-kubernetes-ingress/pull/1380) on [Azure/application-gateway-kubernetes-ingress](https://github.com/Azure/application-gateway-kubernetes-ingress) (4 weeks ago)

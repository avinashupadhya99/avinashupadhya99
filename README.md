...
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/python/v0.5.1](https://github.com/dagger/dagger/releases/tag/sdk/python/v0.5.1), today) - A programmable CI/CD engine that runs your pipelines in containers
- [Azure/azure-cli](https://github.com/Azure/azure-cli) ([azure-cli-2.47.0](https://github.com/Azure/azure-cli/releases/tag/azure-cli-2.47.0), 4 days ago) - Azure Command-Line Interface
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.2.6](https://github.com/kubescape/kubescape/releases/tag/v2.2.6), 5 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.
...
- [[Snyk] Fix for 52 vulnerabilities](https://github.com/avinashupadhya99/Store-App/pull/33) on [avinashupadhya99/Store-App](https://github.com/avinashupadhya99/Store-App) (3 days ago)

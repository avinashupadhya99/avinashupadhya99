...
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.2.3](https://github.com/elastic/kibana/releases/tag/v8.2.3), 1 day ago) - Your window into the Elastic Stack
- [mongodb/mongodb-kubernetes-operator](https://github.com/mongodb/mongodb-kubernetes-operator) ([v0.7.4](https://github.com/mongodb/mongodb-kubernetes-operator/releases/tag/v0.7.4), 1 day ago) - MongoDB Community Kubernetes Operator
...
- [getporter/porter](https://github.com/getporter/porter) ([v0.38.12](https://github.com/getporter/porter/releases/tag/v0.38.12), 6 days ago) - Porter enables you to package your application artifact, client tools, configuration and deployment logic together as an installer that you can distribute, and install with a single command.

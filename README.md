...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.4.17](https://github.com/argoproj/argo-cd/releases/tag/v2.4.17), today) - Declarative continuous deployment for Kubernetes.

...
- [avinashupadhya99/kong-pulumi](https://github.com/avinashupadhya99/kong-pulumi) - Pulumi program in Go to create EC2 and necessary infra in AWS to deploy Kong (2 weeks ago)
...
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.5.2](https://github.com/elastic/kibana/releases/tag/v8.5.2), 2 days ago) - Your window into the Elastic Stack
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.8](https://github.com/robusta-dev/robusta/releases/tag/0.10.8), 4 days ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform
...
- [fix link for installing services in promstack guide](https://github.com/Kong/docs.konghq.com/pull/4800) on [Kong/docs.konghq.com](https://github.com/Kong/docs.konghq.com) (4 days ago)

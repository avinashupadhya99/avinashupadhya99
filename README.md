...
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.9.18-alpha](https://github.com/robusta-dev/robusta/releases/tag/0.9.18-alpha), today) - Open source Kubernetes troubleshooting and automation platform
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.4.4](https://github.com/argoproj/argo-cd/releases/tag/v2.4.4), today) - Declarative continuous deployment for Kubernetes.
- [armosec/kubescape](https://github.com/armosec/kubescape) ([v2.0.161](https://github.com/armosec/kubescape/releases/tag/v2.0.161), 1 day ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [getporter/porter](https://github.com/getporter/porter) ([v1.0.0-beta.1](https://github.com/getporter/porter/releases/tag/v1.0.0-beta.1), 2 days ago) - Porter enables you to package your application artifact, client tools, configuration and deployment logic together as an installer that you can distribute, and install with a single command.
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.3.1](https://github.com/elastic/kibana/releases/tag/v8.3.1), 1 week ago) - Your window into the Elastic Stack

...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.180](https://github.com/kubescape/kubescape/releases/tag/v2.0.180), today) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.9-alpha-1](https://github.com/robusta-dev/robusta/releases/tag/0.10.9-alpha-1), 1 week ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform

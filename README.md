...
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.3.2](https://github.com/elastic/kibana/releases/tag/v8.3.2), 1 day ago) - Your window into the Elastic Stack
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.9.18-alpha](https://github.com/robusta-dev/robusta/releases/tag/0.9.18-alpha), 1 day ago) - Open source Kubernetes troubleshooting and automation platform

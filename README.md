...
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.8.0](https://github.com/elastic/kibana/releases/tag/v8.8.0), today) - Your window into the Elastic Stack
- [Azure/azure-cli](https://github.com/Azure/azure-cli) ([azure-cli-2.49.0](https://github.com/Azure/azure-cli/releases/tag/azure-cli-2.49.0), 2 days ago) - Azure Command-Line Interface
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.5.3](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.5.3), 1 week ago) - A programmable CI/CD engine that runs your pipelines in containers

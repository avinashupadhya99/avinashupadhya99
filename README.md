...
- [kubescape/github-action](https://github.com/kubescape/github-action) ([v2.3.6](https://github.com/kubescape/github-action/releases/tag/v2.3.6), 2 days ago) - GitHub action to run Kubescape scans
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.6.2](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.6.2), 1 week ago) - A programmable CI/CD engine that runs your pipelines in containers

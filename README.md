...
- [cncf/glossary](https://github.com/cncf/glossary) - Cloud Native Glossary (6 days ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.2.4](https://github.com/argoproj/argo-cd/releases/tag/v2.2.4), today) - Declarative continuous deployment for Kubernetes.
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([v2.5.0](https://github.com/kubernetes/dashboard/releases/tag/v2.5.0), today) - General-purpose web UI for Kubernetes clusters
...
- [Close profile card in compare view](https://github.com/parca-dev/parca/pull/586) on [parca-dev/parca](https://github.com/parca-dev/parca) (6 days ago)

...
- [strimzi/strimzi-kafka-bridge](https://github.com/strimzi/strimzi-kafka-bridge) - An HTTP bridge for Apache Kafka® (3 days ago)
...
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.4.1](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.4.1), 1 week ago) - A programmable CI/CD engine that runs your pipelines in containers
...
- [docs: fix example for POST request to /topics](https://github.com/strimzi/strimzi-kafka-bridge/pull/781) on [strimzi/strimzi-kafka-bridge](https://github.com/strimzi/strimzi-kafka-bridge) (4 days ago)

...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.178](https://github.com/kubescape/kubescape/releases/tag/v2.0.178), 2 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.5.3](https://github.com/elastic/kibana/releases/tag/v8.5.3), 5 days ago) - Your window into the Elastic Stack
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.5.4](https://github.com/argoproj/argo-cd/releases/tag/v2.5.4), 1 week ago) - Declarative continuous deployment for Kubernetes.

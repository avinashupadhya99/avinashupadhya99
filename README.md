...
- [avinashupadhya99/productcatalogservice](https://github.com/avinashupadhya99/productcatalogservice) -  (2 weeks ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.5.0](https://github.com/argoproj/argo-cd/releases/tag/v2.5.0), 1 day ago) - Declarative continuous deployment for Kubernetes.
- [elastic/kibana](https://github.com/elastic/kibana) ([v7.17.7](https://github.com/elastic/kibana/releases/tag/v7.17.7), 1 day ago) - Your window into the Elastic Stack
...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.173](https://github.com/kubescape/kubescape/releases/tag/v2.0.173), 2 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [parca-dev/parca](https://github.com/parca-dev/parca) ([v0.13.0](https://github.com/parca-dev/parca/releases/tag/v0.13.0), 6 days ago) - Continuous profiling for analysis of CPU and memory usage, down to the line number and throughout time. Saving infrastructure cost, improving performance, and increasing reliability.

...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.3.11](https://github.com/argoproj/argo-cd/releases/tag/v2.3.11), 2 days ago) - Declarative continuous deployment for Kubernetes.
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.5.0](https://github.com/elastic/kibana/releases/tag/v8.5.0), 2 days ago) - Your window into the Elastic Stack
- [Azure/azure-cli](https://github.com/Azure/azure-cli) ([azure-cli-2.42.0](https://github.com/Azure/azure-cli/releases/tag/azure-cli-2.42.0), 2 days ago) - Azure Command-Line Interface
...
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.7-alpha.3](https://github.com/robusta-dev/robusta/releases/tag/0.10.7-alpha.3), 1 week ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform

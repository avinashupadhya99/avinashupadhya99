...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.4.18](https://github.com/argoproj/argo-cd/releases/tag/v2.4.18), today) - Declarative continuous deployment for Kubernetes.

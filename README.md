...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.5.3](https://github.com/argoproj/argo-cd/releases/tag/v2.5.3), today) - Declarative continuous deployment for Kubernetes.

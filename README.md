...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.5.1](https://github.com/argoproj/argo-cd/releases/tag/v2.5.1), today) - Declarative continuous deployment for Kubernetes.

...
- [Fix indentation for secretRef in authentication docs](https://github.com/redpanda-data/docs/pull/1135) on [redpanda-data/docs](https://github.com/redpanda-data/docs) (today)

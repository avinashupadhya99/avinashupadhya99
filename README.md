...
- [kubernetes/website](https://github.com/kubernetes/website) ([snapshot-initial-v1.25](https://github.com/kubernetes/website/releases/tag/snapshot-initial-v1.25), today) - Kubernetes website and documentation repo: 
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.4.0](https://github.com/elastic/kibana/releases/tag/v8.4.0), today) - Your window into the Elastic Stack

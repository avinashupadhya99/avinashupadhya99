...
- [armosec/kubescape](https://github.com/armosec/kubescape) ([v2.0.167](https://github.com/armosec/kubescape/releases/tag/v2.0.167), today) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.1](https://github.com/robusta-dev/robusta/releases/tag/0.10.1), 1 day ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform

...
- [dagger/dagger](https://github.com/dagger/dagger) - A portable devkit for CI/CD pipelines (6 days ago)
- [armosec/kubescape](https://github.com/armosec/kubescape) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning.  (3 weeks ago)
...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.4.10](https://github.com/argoproj/argo-cd/releases/tag/v2.4.10), 4 days ago) - Declarative continuous deployment for Kubernetes.
- [dagger/dagger](https://github.com/dagger/dagger) ([v0.2.30](https://github.com/dagger/dagger/releases/tag/v0.2.30), 5 days ago) - A portable devkit for CI/CD pipelines
- [armosec/kubescape](https://github.com/armosec/kubescape) ([v2.0.167](https://github.com/armosec/kubescape/releases/tag/v2.0.167), 5 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.1](https://github.com/robusta-dev/robusta/releases/tag/0.10.1), 6 days ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform
...
- [Fix link to todoapp example in universe](https://github.com/dagger/dagger/pull/2940) on [dagger/dagger](https://github.com/dagger/dagger) (6 days ago)
...
- [Update link for playground in Readme ](https://github.com/armosec/kubescape/pull/581) on [armosec/kubescape](https://github.com/armosec/kubescape) (3 weeks ago)
...
- [Update link for playground in Readme](https://github.com/armosec/kubescape/pull/579) on [armosec/kubescape](https://github.com/armosec/kubescape) (3 weeks ago)

...
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.6.4](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.6.4), 1 day ago) - A programmable CI/CD engine that runs your pipelines in containers
- [strimzi/strimzi-kafka-bridge](https://github.com/strimzi/strimzi-kafka-bridge) ([0.26.0](https://github.com/strimzi/strimzi-kafka-bridge/releases/tag/0.26.0), 6 days ago) - An HTTP bridge for Apache Kafka®

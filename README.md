...
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.7-alpha.5](https://github.com/robusta-dev/robusta/releases/tag/0.10.7-alpha.5), 1 day ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.176](https://github.com/kubescape/kubescape/releases/tag/v2.0.176), 2 days ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.5.1](https://github.com/elastic/kibana/releases/tag/v8.5.1), 3 days ago) - Your window into the Elastic Stack

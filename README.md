...
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.3.12](https://github.com/argoproj/argo-cd/releases/tag/v2.3.12), today) - Declarative continuous deployment for Kubernetes.

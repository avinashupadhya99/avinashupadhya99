...
- [Azure/azure-cli](https://github.com/Azure/azure-cli) ([azure-cli-2.43.0](https://github.com/Azure/azure-cli/releases/tag/azure-cli-2.43.0), today) - Azure Command-Line Interface
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.2.1](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.2.1), 5 days ago) - A programmable CI/CD engine that runs your pipelines in containers
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.5.3](https://github.com/argoproj/argo-cd/releases/tag/v2.5.3), 1 week ago) - Declarative continuous deployment for Kubernetes.

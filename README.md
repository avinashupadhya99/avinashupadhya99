...
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.6.2](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.6.2), 2 days ago) - A programmable CI/CD engine that runs your pipelines in containers
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.3.6](https://github.com/kubescape/kubescape/releases/tag/v2.3.6), 2 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.

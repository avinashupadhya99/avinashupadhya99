...
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) ([v2.7.0](https://github.com/kubernetes/dashboard/releases/tag/v2.7.0), today) - General-purpose web UI for Kubernetes clusters

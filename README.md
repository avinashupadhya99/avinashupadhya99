...
- [avinashupadhya99/kong-pulumi](https://github.com/avinashupadhya99/kong-pulumi) - Pulumi program in Go to create EC2 and necessary infra in AWS to deploy Kong (3 days ago)
...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.0.175](https://github.com/kubescape/kubescape/releases/tag/v2.0.175), 1 day ago) - Kubescape is a K8s open-source tool providing a multi-cloud K8s single pane of glass, including risk analysis, security compliance, RBAC visualizer and image vulnerabilities scanning. 
- [robusta-dev/robusta](https://github.com/robusta-dev/robusta) ([0.10.7-alpha.4](https://github.com/robusta-dev/robusta/releases/tag/0.10.7-alpha.4), 4 days ago) - Open source Kubernetes monitoring, troubleshooting, and automation platform
- [argoproj/argo-cd](https://github.com/argoproj/argo-cd) ([v2.3.11](https://github.com/argoproj/argo-cd/releases/tag/v2.3.11), 6 days ago) - Declarative continuous deployment for Kubernetes.
- [elastic/kibana](https://github.com/elastic/kibana) ([v8.5.0](https://github.com/elastic/kibana/releases/tag/v8.5.0), 6 days ago) - Your window into the Elastic Stack
- [Azure/azure-cli](https://github.com/Azure/azure-cli) ([azure-cli-2.42.0](https://github.com/Azure/azure-cli/releases/tag/azure-cli-2.42.0), 6 days ago) - Azure Command-Line Interface

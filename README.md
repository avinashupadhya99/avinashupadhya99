...
- [kubescape/kubescape](https://github.com/kubescape/kubescape) ([v2.3.1](https://github.com/kubescape/kubescape/releases/tag/v2.3.1), 2 days ago) - Kubescape is an open-source Kubernetes security platform for your IDE, CI/CD pipelines, and clusters. It includes risk analysis, security, compliance, and misconfiguration scanning, saving Kubernetes users and administrators precious time, effort, and resources.
- [elastic/kibana](https://github.com/elastic/kibana) ([v7.17.10](https://github.com/elastic/kibana/releases/tag/v7.17.10), 3 days ago) - Your window into the Elastic Stack
- [kubescape/github-action](https://github.com/kubescape/github-action) ([v2.3.0](https://github.com/kubescape/github-action/releases/tag/v2.3.0), 3 days ago) - GitHub action to run Kubescape scans

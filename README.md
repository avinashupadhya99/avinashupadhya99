...
- [dagger/dagger](https://github.com/dagger/dagger) ([sdk/nodejs/v0.8.0](https://github.com/dagger/dagger/releases/tag/sdk/nodejs/v0.8.0), today) - A programmable CI/CD engine that runs your pipelines in containers
- [kubescape/github-action](https://github.com/kubescape/github-action) ([v2.3.8](https://github.com/kubescape/github-action/releases/tag/v2.3.8), 4 days ago) - GitHub action to run Kubescape scans
